    ...
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: ColorBase.bgScreen }}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <YStack gap="$3" paddingHorizontal="$4" paddingBottom="$6">
          {isShiftStarted ? (
            ...
            >
              ...
              <AppButton
                ...
                fullWidth
                title="Tutup Shift"
                onPress={() => setIsShiftStarted(false)}
              />
            </YStack>
          ) : (
            ...
            >
              ...
              <TextBodySm color={ColorPrimary.primary200}>
                Siapkan modal awal dan cek perangkat kasir sebelum mulai
                menerima transaksi.
              </TextBodySm>
          ...
          {/* ── Transaksi Terakhir (shift aktif) / Persiapan Shift (sebelum shift) ── */}
          {isShiftStarted ? (
            <YStack gap="$2">
